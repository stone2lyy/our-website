...
import {ParticlePool} from "@site/src/classes/ParticlePool";
import {settings} from "@site/src/classes/constant";
import {Point} from "@site/src/classes/Point";
import {pointOnHeart} from "@site/src/classes/utils";
import useEffectOnce from "@site/src/hooks/useEffectOnce";
  ...
  return (
    <>
      <canvas
        ...
        className={styles.loadCanvas}
      />
      <p className={styles.mentions}>宝宝别走开，马上就加载好了......</p>
    </>
  );
};
